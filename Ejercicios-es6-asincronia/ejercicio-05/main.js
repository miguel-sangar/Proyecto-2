...
input.addEventListener("input", () => {
    //Filtrar en función de lo que se escriba en el input:
    const filtrados = streamers.filter(streamer => streamer.name.includes(input.value));
    //Mostrar en tiempo real los posibles resultados:
